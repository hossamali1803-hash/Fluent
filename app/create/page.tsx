...
export default function CreatePage() {
  ...
  async function generate() {
    ...
    try {
      ...
      const data: GeneratedTemplate = await res.json();
      setScenario(data);
    } catch {
      setError("Couldn't generate. Try rephrasing your description.");
    }
  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto", padding: "24px 20px 60px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 28 }}>
        ...
        >←</button>
        <div>
          <div style={{ fontSize: 20, fontWeight: 800, color: "#1a1a2a" }}>Create your scenario</div>
          <div style={{ color: "#6b6b8a", fontSize: 13 }}>Describe it — we'll build the practice</div>
        </div>
      </div>
      ...
      <div style={{ background: "#ffffff", borderRadius: 16, border: "1px solid #ece9ff", overflow: "hidden", marginBottom: 14, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
        <textarea
          ...
          style={{
            width: "100%", minHeight: 110, padding: "16px", border: "none", outline: "none", resize: "none",
            fontSize: 15, lineHeight: 1.5, color: "#1a1a2a", background: "transparent",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 14px 14px" }}>
          ...
          <button
            ...
            style={{
              ...
              background: isRecording ? "#ef4444" : "#f0eeff",
              border: isRecording ? "none" : "1px solid #d4c9ff",
      ...
      <button
        ...
        style={{
          ...
          background: isGenerating ? "#f0eeff" : "#f59e0b",
          color: isGenerating ? "#6b6b8a" : "#0f0e17",
          fontSize: 16, fontWeight: 800, cursor: isGenerating ? "default" : "pointer",
          marginBottom: 28, display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
          opacity: (isRecording || isTranscribing) ? 0.5 : 1,
        }}
      >
        {isGenerating ? (
          <>
            <span style={{ display: "inline-block", width: 14, height: 14, border: "2px solid #6b6b8a", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.7s linear infinite" }} />
      ...
      {/* Generated preview */}
      {scenario && (
        <div style={{ background: "#ffffff", borderRadius: 20, border: "1px solid #f59e0b40", padding: 22, marginBottom: 28, boxShadow: "0 2px 8px rgba(245,158,11,0.1)" }}>
          <div style={{ color: "#f59e0b", fontSize: 11, fontWeight: 700, letterSpacing: 1.4, textTransform: "uppercase", marginBottom: 14 }}>Your scenario</div>

          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            <div style={{ width: 48, height: 48, borderRadius: "50%", background: "linear-gradient(135deg, #f59e0b, #f97316)", display: "flex", alignItems: "center", justifyContent: "center", color: "#0f0e17", fontWeight: 800, fontSize: 18, flexShrink: 0 }}>
              {scenario.persona[0]}
            </div>
            <div>
          ...
          <div style={{ background: "#fffbf0", borderRadius: 12, padding: "12px 14px", marginBottom: 20, borderLeft: "3px solid #f59e0b" }}>
          ...
          <button
            ...
            style={{ width: "100%", background: "#f59e0b", color: "#0f0e17", border: "none", borderRadius: 14, padding: "15px", fontSize: 16, fontWeight: 800, cursor: "pointer", marginBottom: 8 }}
          >Start practice</button>
          <button
            onClick={generate}
            style={{ width: "100%", background: "transparent", color: "#6b6b8a", border: "none", borderRadius: 14, padding: "10px", fontSize: 14, cursor: "pointer" }}
          >Regenerate</button>
        </div>
      )}
          ...
          {EXAMPLES.map((ex) => (
            <button
              ...
              style={{
                ...
                textAlign: "left", boxShadow: "0 1px 3px rgba(0,0,0,0.04)",
              }}
            >
